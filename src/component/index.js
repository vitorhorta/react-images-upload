...
class ReactImageUploadComponent extends React.Component {
    ...
    onPreviewClick = (picture, index) => {
        let sortedPictures = this.state.pictures.slice();
        sortedPictures.splice(index,1);
        sortedPictures.unshift(this.state.pictures[index]);
        this.setState({pictures: sortedPictures});
            ...
            return (
                <div key={index} className="uploadPictureContainer">
                    ...
                    <img src={picture} className="uploadPicture" alt="preview"
                         onClick={() => this.onPreviewClick(picture, index)}/>
                </div>
            );
        });
    }
